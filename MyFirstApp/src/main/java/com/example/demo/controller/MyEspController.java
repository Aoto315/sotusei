...
public class MyEspController {
	...
	public String viewPage(Model model) {
		...
		List<Esptran> esptranslist = esptranRepository.findAll();
		
		model.addAttribute("esptranslist", esptranslist);
	...
	public String postTuika(String jpn, Model model) {
		...
		List<Esptran> esptranslist = esptranRepository.findByJpnLike("%" + jpn + "%");
