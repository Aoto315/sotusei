...
public class ItemdbController {
	...
	public String itemsPostRegist(String item_id, String item_name, String item_price, MultipartFile upimage,
		...
		//データ登録SQL実行
		jdbcTemplate.update("INSERT INTO items SET item_id=?,item_name=?,item_image=? ,item_price = ?;", item_id,
				item_name, encodedImage, item_price);
	...
	public String itemsPostUpdate(String item_id, String item_name, String item_price, MultipartFile upimage,
		...
		//データ登録SQL実行
		jdbcTemplate.update("UPDATE items SET item_name=?,item_price=?,item_image=? WHERE item_id=?;", item_name,
				item_price, encodedImage,item_id);
