...
public class MyThirteenthController {
	...
	public String drink(Model model, String drink_id, String drink_name, String drink_price) {

		Drinks myDrink = new Drinks();

		myDrink.setDrink_id(Integer.parseInt(drink_id));
		myDrink.setDrink_name(drink_name);
		myDrink.setDrink_price(Integer.parseInt(drink_price));
