...
public class MyLineApiController {
	...
	//ここにチャンネルアクセストークンを貼る！
	String channelAccessToken = "hHClqTJ7qeU2rPDhlcJdn1Ieo4+UD8Ox1DaInKIcctMUEeUM1o9I7QJ6+Y5MuX8JxioY2VxDHv7RyzP0QBLgVtXouNn0W1p8ovvP/IOYM+bXsOr6OVyvwW0JUQE8xIU/yj3kT4wia1EES+XyPfsvdAdB04t89/1O/w1cDnyilFU=";
	...
	public void postApidata(@RequestBody LineData webhookData) {
		...
		if(replyText.startsWith("質問")) {
			...
			if("何か聞きたい".equals(replyText)) {
				//メッセージを返す
				replyMessage(replyToken, "質問をどうぞ。先頭に「質問」をつけて聞いてください。");
