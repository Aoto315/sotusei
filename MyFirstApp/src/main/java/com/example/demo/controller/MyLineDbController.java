...
public class MyLineDbController {
	...
	//ここにチャンネルアクセストークンを貼る！
	String channelAccessToken = "ここにチャネルアクセストークンを貼る";
	...
	public void postApidata(@RequestBody LineData webhookData) {
		for (Event event : webhookData.getEvents()) {
			...
			String numataImg = "hHClqTJ7qeU2rPDhlcJdn1Ieo4+UD8Ox1DaInKIcctMUEeUM1o9I7QJ6+Y5MuX8JxioY2VxDHv7RyzP0QBLgVtXouNn0W1p8ovvP/IOYM+bXsOr6OVyvwW0JUQE8xIU/yj3kT4wia1EES+XyPfsvdAdB04t89/1O/w1cDnyilFU=";
